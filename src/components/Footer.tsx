    ...
    <footer className="bg-[#193d2a] text-white py-6">
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center space-y-4">
        ...
        <p className="text-sm text-right">
          Built using <span className="font-semibold">React</span>, <span className="font-semibold">TypeScript</span>,{" "}
          <span className="font-semibold">Vite</span>, <span className="font-semibold">TailwindCSS</span>, and{" "}
